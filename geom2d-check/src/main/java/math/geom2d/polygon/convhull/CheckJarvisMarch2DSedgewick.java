 ...
 *
 */
public class CheckJarvisMarch2DSedgewick extends JPanel{
	...
	public CheckJarvisMarch2DSedgewick() {
		super();
	...
	public void paintComponent(Graphics g){
		...
		Polygon2D hull = new JarvisMarch2D().convexHull(points.points());
	...
	public final static void main(String[] args){
		...
		JPanel panel = new CheckJarvisMarch2DSedgewick();
