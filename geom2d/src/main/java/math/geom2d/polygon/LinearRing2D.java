...
/**
 * <p>
 * A LinearRing2D is a Polyline2D whose last point is connected to the first
 * one. This is typically the boundary of a SimplePolygon2D.
 * </p>
 * <p>
...
public class LinearRing2D extends LinearCurve2D implements CirculinearRing2D {
    ...
    /**
     * Returns an array of LineSegment2D. The number of edges is the same as the
     * number of vertices.
     *
