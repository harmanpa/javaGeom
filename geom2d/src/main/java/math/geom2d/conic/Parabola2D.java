...
public class Parabola2D extends AbstractSmoothCurve2D
    ...
    public int hashCode() {
        int hash = 7;
        hash = 83 * hash + (int) (Double.doubleToLongBits(this.xv) ^ (Double.doubleToLongBits(this.xv) >>> 32));
        hash = 83 * hash + (int) (Double.doubleToLongBits(this.yv) ^ (Double.doubleToLongBits(this.yv) >>> 32));
        hash = 83 * hash + (int) (Double.doubleToLongBits(this.theta) ^ (Double.doubleToLongBits(this.theta) >>> 32));
