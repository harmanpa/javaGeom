...
public class Circle2D extends AbstractSmoothCurve2D
        implements EllipseShape2D, CircleLine2D, CircularShape2D, CirculinearRing2D, ClosedShape2D {
     ...
     */
    public static Circle2D circumCircle(Point2D p1, Point2D p2, Point2D p3) throws ColinearPoints2DException {
     ...
     * @throws ColinearPoints2DException if the 3 points are colinear
     */
    public static Point2D circumCenter(Point2D p1, Point2D p2, Point2D p3) throws ColinearPoints2DException {
