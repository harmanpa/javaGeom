...
public class Hyperbola2D extends ContourArray2D<HyperbolaBranch2D>
     ...
     * coefficients for x^2, xy, and y^2 factors. If the array is longer,
     * remaining coefficients are ignored.
    ...
    /**
     * Transforms an hyperbola, by supposing both the hyperbola is centered and
    ...
    public int hashCode() {
        int hash = 3;
        hash = 47 * hash + (int) (Double.doubleToLongBits(this.xc) ^ (Double.doubleToLongBits(this.xc) >>> 32));
        hash = 47 * hash + (int) (Double.doubleToLongBits(this.yc) ^ (Double.doubleToLongBits(this.yc) >>> 32));
