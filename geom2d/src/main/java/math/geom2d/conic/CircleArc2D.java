...
public class CircleArc2D extends AbstractSmoothCurve2D
        implements EllipseArcShape2D, CircularShape2D, CirculinearElement2D {
    ...
    /**
     * Returns curvature of the circle arc. This is the same as the curvature of
     * the parent circle, with a control on the sign that depends on the
     * orientation.
     */
