...
public class HyperbolaBranch2D extends AbstractSmoothCurve2D
    ...
    // Static constructor
    /**
     * Generic constructor, using a parent Hyperbola, and a boolean to specifies
     * if the branch is the right one (crossing the Ox axis on positive side, b
     * true), or the left one (crossing the Oy axis on the negative side, b
     * false).
     */
    ...
    /**
     * Clips the curve with a box. The result is an instance of CurveSet2D,
     * which contains only instances of HyperbolaBranchArc2D. If the curve does
     * not intersect the boundary of the box, the result is an instance of
    ...
    public boolean almostEquals(GeometricObject2D obj, double eps) {
        ...
        if (!hyperbola.almostEquals(branch.hyperbola, eps)) {
            return false;
        }
