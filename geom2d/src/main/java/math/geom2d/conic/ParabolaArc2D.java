...
public class ParabolaArc2D extends AbstractSmoothCurve2D
     ...
     * ParabolaArc2D. If the parabola arc is not clipped, the result is an
     * instance of CurveSet2D<ParabolaArc2D>
    ...
    public int hashCode() {
        int hash = 3;
        hash = 97 * hash + Objects.hashCode(this.parabola);
        hash = 97 * hash + (int) (Double.doubleToLongBits(this.t0) ^ (Double.doubleToLongBits(this.t0) >>> 32));
        hash = 97 * hash + (int) (Double.doubleToLongBits(this.t1) ^ (Double.doubleToLongBits(this.t1) >>> 32));
        return hash;
    }
