...
public class RoundJoinFactory implements JoinFactory {
     ...
     * distance. The first point of curve2 is assumed to be the last point of
     * curve1.
     */
    @Override
    public CirculinearContinuousCurve2D createJoin(
        ...
        double startAngle2 = new Vector2D(center, previousParallelEnd).angle();
        double endAngle2 = new Vector2D(center, nextParallelStart).angle();
