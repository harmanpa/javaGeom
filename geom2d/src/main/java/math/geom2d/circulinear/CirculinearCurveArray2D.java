...
public class CirculinearCurveArray2D<T extends CirculinearCurve2D>
    ...
    // static constructors
    /**
     * Static factory for creating a new CirculinearCurveArray2D from a
    ...
    /**
     * Static factory for creating a new CirculinearCurveArray2D from an array
     * of curves.
     *
     * @since 0.8.1
     */
    ...
    public CirculinearCurveArray2D<? extends CirculinearCurve2D>
        ...
        for (Curve2D curve : subcurve) {
            if (curve instanceof CirculinearCurve2D) {
                ...
                result.add(CirculinearCurves2D.convert(curve));
            }
        }
