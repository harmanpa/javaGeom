 ...
 * curves. Instances of this class can be circulinear rings (composed of several
 * continuous and finite circulinear curves that form a loop), or an open curve
 * with two infinite circulinear curve at each extremity.
 *
 * @author dlegland
 *
 */
