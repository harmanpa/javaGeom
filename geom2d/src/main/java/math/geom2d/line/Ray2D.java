...
public class Ray2D extends AbstractLine2D {
    ...
    /**
     * Creates a new Ray2D, originating from <code>point1<\code>, and going in
     * the direction of <code>point2<\code>.
     */
    ...
    /**
     * Creates a new Ray2D, originating from point <code>(x, y)<\code>, and
     * going in the direction specified by <code>angle<\code> (in radians).
     */
    ...
    /**
     * Creates a new Ray2D, originating from point <code>(x1,y1)<\code>, and
     * going in the direction defined by vector <code>(dx, dy)<\code>.
     */
