...
public class StraightLine2D extends AbstractLine2D implements
    ...
    /**
     * Defines a new Straight line going through the point (xp, yp) and with the
     * direction vector given by (dx, dy).
     */
    ...
    /**
     * Copy constructor: Defines a new Straight line at the same position and
     * with the same direction than an other straight object (line, edge or
     * ray).
     */
    ...
    /**
     * Returns the parallel line located at a distance d from the line. Distance
