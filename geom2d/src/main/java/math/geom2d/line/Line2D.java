 ...
 * memory, and recomputes properties directly from points. Line2D is mutable.
 * <p>
 * Example :
 * <p>
 * <code>
 ...
 * processing. Moreover, as inner point fields are public, it is not as safe as
 * {@link math.geom2d.line.LineSegment2D}.
 */
public class Line2D extends AbstractSmoothCurve2D
    ...
    // Static factory
    /**
     * Static factory for creating a new Line2D, starting from p1 and finishing
     * at p2.
     *
    ...
    /**
     * Creates a straight line perpendicular to this object, and passing through
     * the given point.
     *
     * @param point the point to go through
     ...
     * If point does not belong to edge, return Double.NaN. The current
     * implementation uses the direction with the biggest derivative, in order
    ...
    /**
     * Two Line2D are equals if the share the two same points, in the same
     * order.
     *
