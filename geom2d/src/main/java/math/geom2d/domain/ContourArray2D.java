...
public class ContourArray2D<T extends Contour2D> extends CurveArray2D<T>
     ...
     * CurveSet2D<ContinuousOrientedCurve2D>, which contains only instances of
     * ContinuousOrientedCurve2D. If the curve is not clipped, the result is an
     * instance of CurveSet2D<ContinuousOrientedCurve2D> which contains 0
     * curves.
     */
    @Override
