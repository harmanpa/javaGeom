...
public class PolyOrientedCurve2D<T extends ContinuousOrientedCurve2D> extends
    ...
    // static constructors
    /**
     * Static factory for creating a new PolyOrientedCurve2D from a collection
     * of curves.
     *
     * @since 0.8.1
     */
    ...
    /**
     * Static factory for creating a new PolyOrientedCurve2D from a collection
     * of curves and a flag indicating if the curve is closed or not.
     *
     * @since 0.9.0
     */
    /*public static <T extends ContinuousOrientedCurve2D> PolyOrientedCurve2D<T>
    ...
    /**
     * Clips the PolyCurve2D by a box. The result is an instance of CurveSet2D,
     * which contains only instances of ContinuousOrientedCurve2D. If the
     * PolyCurve2D is not clipped, the result is an instance of CurveSet2D which
     * contains 0 curves.
     */
    @Override
