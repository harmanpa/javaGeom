...
public class Angle2D {
    ...
    public static double horizontalAngle(Point2D point) {
        return (FastMath.atan2(point.y, point.x) + M_2PI) % (M_2PI);
    }
    ...
    public static double horizontalAngle(double x, double y) {
        return (FastMath.atan2(y, x) + M_2PI) % (M_2PI);
    }
    ...
    public static double horizontalAngle(Vector2D vect) {
        return (FastMath.atan2(vect.y, vect.x) + M_2PI) % (M_2PI);
    }
    ...
    public static double horizontalAngle(Point2D p1, Point2D p2) {
        return (FastMath.atan2(p2.y - p1.y, p2.x - p1.x) + M_2PI) % (M_2PI);
    }
    ...
    public static double horizontalAngle(double x1, double y1, double x2,
            double y2) {
        return (FastMath.atan2(y2 - y1, x2 - x1) + M_2PI) % (M_2PI);
    }
    ...
    /**
     * Returns the oriented angle between two vectors. Result is given in
    ...
    /**
     * Returns the oriented angle between the ray formed by (p2, p1) and the ray
     * formed by (p2, p3). Result is given in radians, between 0 and 2*PI.
     */
    ...
    public static boolean equals(double angle1, double angle2) {
        ...
        if (Math.abs(diff - PI * 2) < Tolerance2D.get()) {
            return true;
        }
        return false;
    }
