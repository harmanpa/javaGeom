...
public class PolyCurve2D<T extends ContinuousCurve2D> extends CurveArray2D<T>
    ...
    /**
     * Static factory for creating a new PolyCurve2D from an array of curves and
     ...
     * CurveSet2D<ContinuousCurve2D>, which contains only instances of
     * ContinuousCurve2D. If the PolyCurve2D is not clipped, the result is an
     * instance of CurveSet2D<ContinuousCurve2D>
