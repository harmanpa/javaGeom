 ...
 */
public class Box2D implements GeometricObject2D {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 79 * hash + (int) (Double.doubleToLongBits(this.xmin) ^ (Double.doubleToLongBits(this.xmin) >>> 32));
        hash = 79 * hash + (int) (Double.doubleToLongBits(this.xmax) ^ (Double.doubleToLongBits(this.xmax) >>> 32));
        hash = 79 * hash + (int) (Double.doubleToLongBits(this.ymin) ^ (Double.doubleToLongBits(this.ymin) >>> 32));
        hash = 79 * hash + (int) (Double.doubleToLongBits(this.ymax) ^ (Double.doubleToLongBits(this.ymax) >>> 32));
        return hash;
    }
