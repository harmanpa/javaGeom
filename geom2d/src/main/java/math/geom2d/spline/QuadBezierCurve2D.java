 ...
 * the first control point and finished at the third control point. The second
 * point is used to defined the curvature of the curve.
 *
...
public class QuadBezierCurve2D extends AbstractSmoothCurve2D
    ...
    /**
     * Returns the first point of the curve, that corresponds to the first
     * control point.
     *
    ...
    /**
     * Returns the last point of the curve, that corresponds to the third
     * control point.
     *
    ...
    /**
     * Clip the curve by a box. The result is an instance of CurveSet2D, which
     * contains only instances of QuadBezierCurve2D. If the curve is not
    ...
    public int hashCode() {
        ...
        hash = 97 * hash + (int) (Double.doubleToLongBits(this.ctrlx) ^ (Double.doubleToLongBits(this.ctrlx) >>> 32));
        hash = 97 * hash + (int) (Double.doubleToLongBits(this.ctrly) ^ (Double.doubleToLongBits(this.ctrly) >>> 32));
