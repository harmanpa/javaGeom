 ...
 * the first and the last control points. The second and the third control
 * points defines the tangents at the extremities of the curve.
 *
...
public class CubicBezierCurve2D extends AbstractSmoothCurve2D
     ...
     *
     * @see
     * math.geom2d.curve.Curve2D#intersections(math.geom2d.line.LinearShape2D)
     */
    ...
    public int hashCode() {
        ...
        hash = 29 * hash + (int) (Double.doubleToLongBits(this.ctrlx1) ^ (Double.doubleToLongBits(this.ctrlx1) >>> 32));
        hash = 29 * hash + (int) (Double.doubleToLongBits(this.ctrly1) ^ (Double.doubleToLongBits(this.ctrly1) >>> 32));
        hash = 29 * hash + (int) (Double.doubleToLongBits(this.ctrlx2) ^ (Double.doubleToLongBits(this.ctrlx2) >>> 32));
        hash = 29 * hash + (int) (Double.doubleToLongBits(this.ctrly2) ^ (Double.doubleToLongBits(this.ctrly2) >>> 32));
        hash = 29 * hash + (int) (Double.doubleToLongBits(this.x2) ^ (Double.doubleToLongBits(this.x2) >>> 32));
        hash = 29 * hash + (int) (Double.doubleToLongBits(this.y2) ^ (Double.doubleToLongBits(this.y2) >>> 32));
        return hash;
    }
