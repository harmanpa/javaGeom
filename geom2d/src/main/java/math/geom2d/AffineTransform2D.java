...
public class AffineTransform2D implements Bijection2D, GeometricObject2D {
     ...
     *
     * @return
     * @throws math.geom2d.NonInvertibleTransform2DException
     * @since 0.6.3
     */
    @Override
    public AffineTransform2D invert() throws NonInvertibleTransform2DException {
        double det = m00 * m11 - m10 * m01;

        if (Math.abs(det) < Tolerance2D.get()) {
