...
public class Vector2D implements GeometricObject2D {
    ...
    /**
     * Constructs a new vector with the given coordinates. Consider creating a
     * new Vector using static factory.
     */
    ...
    /**
     * Get the dot product with point <code>p</code>. Dot product id defined by:
     * <p>
    ...
    /**
     * Get the cross product with point <code>p</code>. Cross product is defined
     * by :
     * <p>
     * <code> x1*y2 - x2*y1</code>
     * <p>
