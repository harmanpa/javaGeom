package math.geom3d.utils.simplify;
...
public class FastMath {
     ...
     *
     * E.g. for an input 100, this returns 128. Returns 1 for all numbers less
     * than or equal to 1.
     *
...
//        }
     ...
     * @param p2 control point 2
     * @param p3 control point 3
     * @param store a cloudmtr.Vector3f to store the result
     * @return Catmull鈥揜om interpolation
     */
    ...
    /**
     * Compute the length of a Catmull鈥揜om spline between control points 1 and 2
     *
     * @param p0 control point 0
     * @param p1 control point 1
     * @param p2 control point 2
     ...
     * <p>
     * Source:
     * <a href="ftp://www.fox-toolkit.org/pub/fasthalffloatconversion.pdf">
