 ...
 * 
 */
public class TestMultiSheets1b {
	...
	private double[][] result_position; // result_cos_sin[9] denotes the x,y-coordinate of the 9th polygon w.r.t its reference point
        ...
        @Test
	public void setup() throws PackingException, CloneNotSupportedException {
		//size(1300, 800);
		int seed = 4346;
		ran = new Random(seed);
		randompolys = randomPolygons(52);// prepare the input polygons
