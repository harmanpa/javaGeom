...
public class RoundedCylinder extends Primitive {
    ...
    public List<Polygon> toPolygons() throws QuickHullException {
        ...
        List<CSG> cylParts = new ArrayList<>();
        ...
        return HullUtil.hull(cylParts.toArray(new CSG[0])).toZMin().getPolygons();
    }
    ...
    public final RoundedCylinder setNumCornerSlices(int numCornerSlices) {
